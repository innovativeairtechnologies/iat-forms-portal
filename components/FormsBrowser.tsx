...
/**
 * The form-browsing UI shared by the public /forms directory and the employee
 * Resources hub: search, category tabs, collapsible by-category groups, flat
 * search/category results, and the in-place form-fill modal. It renders no page
 * chrome (header/hero) — the parent provides that and the width container.
 */
export default function FormsBrowser({ categories, forms }: Props) {
