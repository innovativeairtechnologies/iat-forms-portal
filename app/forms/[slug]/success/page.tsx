    ...
    <div className="min-h-screen bg-[#f5f5f7] dark:bg-gray-950">
      ...
      <div className="flex items-center justify-center px-4 py-16">
        <div className="w-full max-w-md">
          ...
          {/* Success card */}
          <div className="bg-white dark:bg-gray-900 rounded-2xl border border-black/[0.06] dark:border-white/10 shadow-card px-8 py-10 text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              ...
              <Link
                href="/"
                className="inline-flex items-center gap-2 text-[13px] font-medium text-gray-400 hover:text-[#0a0a0b] dark:hover:text-white px-4 py-2.5 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors"
              >
                <ArrowLeft size={13} />
                Back to forms
              </Link>
